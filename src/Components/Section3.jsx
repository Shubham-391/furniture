...
function Section3() {
  ...
  return (
    <>
      <div className="bg-white pt-12 md:pt-[135px] pb-12 md:pb-[169px]">
        <div className="max-w-[1353px] mx-auto pl-3 min-[1200px]:pl-4 pr-3">
          ...
          <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center mb-[90px]">
          ...
          <div className="flex flex-wrap gap-x-[27px] gap-y-[42px] justify-center min-[1200px]:pr-[5px]">
